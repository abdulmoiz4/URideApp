...
namespace URideApp.Controllers
{
   [Authorize]
    public class HomeController : Controller
    {
        ...
        public JsonResult SearchName1(string SearchKeyword)
        {
            Models.FinalMVCProjectQueryEntities db = new Models.FinalMVCProjectQueryEntities();
            List<string> names = db.PassengerInfoes.Where(i => i.PassengerName.Contains(SearchKeyword)).Select(o => o.PassengerName).ToList();
            return Json(names, JsonRequestBehavior.AllowGet);
        }
